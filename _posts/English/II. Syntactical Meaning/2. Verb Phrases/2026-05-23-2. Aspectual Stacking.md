...
<br>
형식적으로 명확히하여 그 한계가 어디서 드러나는지 보자. sentence(free variable이 없는 formula) 변수 $p$에 대해서 $ET(p)$를 $p$의 event time으로 정의하자. 비슷하게 sentence의 topic time $TT(p)$ 도 정의하자. 그리고 두 개의 predicate를 정의하자: 
