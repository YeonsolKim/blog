...
Tense: relative past($TT_{non-finite} < TT_{matrix}$)<br>

**Having discovered that elliptical orbits fit the observations, he could not reconcile them with his idea.**
* Supplement(Gerund-Participial Clause)
  * Predicand: he
  * Predicate: Having discovered that elliptical orbits fit the observations
    * Head(Auxiliary Verb): Having(anterior past-time relation을 나타내는 marker)
    * Complement(VP): discovered that elliptical orbits fit the observations
* Matrix Clause